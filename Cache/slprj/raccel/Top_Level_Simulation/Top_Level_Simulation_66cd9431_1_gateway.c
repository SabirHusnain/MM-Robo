...
#endif
#include "nesl_rtw.h"
#include "Top_Level_Simulation_66cd9431_1.h"
#include "Top_Level_Simulation_66cd9431_1_gateway.h"
void Top_Level_Simulation_66cd9431_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 1 , 0.001 , 0.001 , 0.001 , 1 , 0 , (
NeModifyAbsTol ) 0 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 ,
612191066 , 0 , 0 , } ; NeSolverParameters solverparams = { 0 , (
...
Top_Level_Simulation_66cd9431_1_dae ( & dae , & modelparams , & solverparams
