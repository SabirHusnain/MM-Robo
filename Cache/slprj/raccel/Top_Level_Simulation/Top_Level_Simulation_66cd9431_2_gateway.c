...
#endif
#include "nesl_rtw.h"
#include "Top_Level_Simulation_66cd9431_2.h"
#include "Top_Level_Simulation_66cd9431_2_gateway.h"
void Top_Level_Simulation_66cd9431_2_gateway ( void ) { NeModelParameters
...
Top_Level_Simulation_66cd9431_2_dae ( & dae , & modelparams , & solverparams
