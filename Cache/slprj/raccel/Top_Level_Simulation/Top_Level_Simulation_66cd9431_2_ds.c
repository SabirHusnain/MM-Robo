...
#include "Top_Level_Simulation_66cd9431_2_ds_dxf.h"
...
[ 2 ] = { {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.x"
, 0U , 0 ,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, 1.0 , "1" , 0.0 , TRUE , FALSE , { { 1 , 1 } } , NE_INIT_MODE_MANDATORY ,
"Position" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.f"
, 0U , 0 ,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, 1.0 , "1" , 0.0 , FALSE , FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE ,
"Force" , } } ; static NeVariableData s_discrete_data [ 1 ] = { {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.M"
, 0U , 0 ,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, 1.0 , "1" , 0.0 , FALSE , FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE ,
"Hard stop mode" , } } ; static NeObservableData s_observable_data [ 23 ] = {
{
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.MTRef2.V.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/MTRef2"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.C.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
...
"Hard stop mode" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.R.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
...
"Position" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.C.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Force_Sensor.C.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Force Sensor"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Force_Sensor.F"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Force Sensor"
, { { 1 , 1 } } , "N" , 1.0 , "N" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "F"
, } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Force_Sensor.R.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Force Sensor"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
...
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Force" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Force_Sensor_F0"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational\nSimscape Multibody2/External Force\nand Torque F"
...
"Ideal_Force_Sensor_F0" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Translational_Velocity_Source.C.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Translational Velocity Source"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Translational_Velocity_Source.R.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Translational Velocity Source"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Translational_Velocity_Source.S"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Translational Velocity Source"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "S"
, } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Translational_Velocity_Source.f"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Translational Velocity Source"
, { { 1 , 1 } } , "N" , 1.0 , "N" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Force" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Ideal_Translational_Velocity_Source.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Ideal Translational Velocity Source"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.R.v"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2"
, { { 1 , 1 } } , "m/s" , 1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Velocity" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Sign_Force_B.I"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Sign Force B"
, { { 1 , 1 } } , "N" , 1.0 , "N" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "I"
, } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Sign_Force_B.O"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Simscape Multibody2/Sign Force B"
, { { 1 , 1 } } , "N" , 1.0 , "N" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "O"
, } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Sign_Force_B_O0"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational\nSimscape Multibody2/External Force\nand Torque B"
, { { 1 , 1 } } , "kg*m/s^2" , 1.0 , "N" , NE_NOMINAL_SOURCE_MODEL ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Sign_Force_B_O0" , } , {
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Simscape_Multibody2.Transform_Sensor_vz0"
,
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational\nSimscape Multibody2/Transform\nSensor"
...
NeAssertData s_assert_data [ 8 ] = { {
 "Top_Level_Simulation/Simulation Environment/Position Actuated Robot Environment/Position Actuated Manipulator/Translational Hard Stop1"
, 1U , 0U ,
 "Simulation_Environment.Position_Actuated_Robot_Environment.Position_Actuated_Manipulator.Translational_Hard_Stop1"
,
...
NeDynamicSystem * Top_Level_Simulation_66cd9431_2_dae_ds ( PmAllocator *
...
Top_Level_Simulation_66cd9431_2_ds_f ; ds -> mMakeOutput [ NE_DS_METHOD_F ] =
...
Top_Level_Simulation_66cd9431_2_ds_dxf ; ds -> mMakeOutput [ NE_DS_METHOD_DXF
] = ds_output_dxf ; ds -> mMethods [ NE_DS_METHOD_DUF_P ] = ds_duf_p ; ds ->
mMakeOutput [ NE_DS_METHOD_DUF_P ] = ds_output_duf_p ; ds -> mMethods [
NE_DS_METHOD_DUF ] = Top_Level_Simulation_66cd9431_2_ds_duf ; ds ->
